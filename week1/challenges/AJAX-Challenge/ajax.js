...
// The variable declared below represents the HTML 
// element that is going to receive text
let input = document.getElementById("input");

// In AJAX, you send a request using the XMLHttpRequest object,
// which is built into JS and all modern broswers
...
function ajaxFunc() {
  ...
  */
  ...
  // be required to know some of its properties (TWO MONDAYS FROM NOW).
  ...
  */
  ...
  xhr.onreadystatechange = function() {
    ...
    if(this.readyState == 4 && this.status == 200) {
      ...
      renderHTML(data); // this renderHTML() function is defined at the bottom of this page - it is hoisted
    }
  }
...
// The function below renders the image of the Pokemon
